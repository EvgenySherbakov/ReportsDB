...
st.caption(
    "Разделы файла: отчёты с объёмами, таблицы-источники, кандидаты на вывод, "
    "глубина хранения, время выполнения, сводка по РЦ и сетям. Поиск и "
    "сортировка внутри файла работают без интернета."
)
