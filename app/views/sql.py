...
OBJECTS = {
    ...
    "v_report_plant_twin": "Двойник отчёта на другом заводе своей ТС: тёзки и "
                           "ближайший по набору таблиц, со сходством. Порог "
                           "уникальности задаёт читатель, в витрине его нет.",
...
COLUMNS = {
    ...
    "plant": "Завод.",
    "best_jaccard": "Сходство набора таблиц с ближайшим отчётом другого завода "
                    "своей ТС: 1.0 — наборы совпадают. NULL — такого отчёта "
                    "нет (или у отчёта нет таблиц).",
    "best_shared_tables": "Сколько таблиц общих с этим ближайшим отчётом.",
    "name_twin_count": "Сколько отчётов с тем же наименованием стоит на других "
                       "заводах своей ТС.",
    "plants_compared": "С каким числом других заводов ТС было что сравнивать. "
                       "0 — завод в ТС один.",
